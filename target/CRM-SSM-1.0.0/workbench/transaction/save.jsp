		...
		$(function () {
			...
			$("#create-stage").change(function () {
				...
				/*
					...
					阶段有了stage
					阶段和可能性之间的对应关系pMap，但是pMap是Java语言中的键值对关系（java中的map）
					我们首先的将pMap转换为js中的键值对的关系json
				...
				/*
					...
					因为今天的stage是一个可变的变量
					如果是这样的key,那么我们就不能以传统的json.key 的形式来取值
					我们要使用的取值方式为
					json[key]
...
<body>
	...
	<form class="form-horizontal" action="workbench/transaction/save.do" method="post" id="saveForm" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="百度推广123">
				<input type="hidden" value="6b57d45ed4c24d65b948c0b21f2aa49b">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="38e59783f88c4d439000f38567fa6f85" name="contactsId">
			</div>
		</div>
